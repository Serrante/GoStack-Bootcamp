...
var listProviderAppointmentsService;
describe('listProviderAppointments', function () {
    beforeEach(function () {
        fakeAppointmentsRepository = new FakeAppointmentsRepository_1.default();
        listProviderAppointmentsService = new ListProviderAppointmentsService_1.default(fakeAppointmentsRepository);
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, listProviderAppointmentsService.execute({
                            provider_id: 'provider',
                            year: 2020,
                            month: 5,
                            day: 20,
