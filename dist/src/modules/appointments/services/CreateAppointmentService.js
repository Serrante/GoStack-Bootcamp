...
var CreateAppointmentsService = /** @class */ (function () {
    function CreateAppointmentsService(appointmentsRepository, notificationsRepository) {
        this.appointmentsRepository = appointmentsRepository;
        this.notificationsRepository = notificationsRepository;
    }
    CreateAppointmentsService.prototype.execute = function (_a) {
        var provider_id = _a.provider_id, user_id = _a.user_id, date = _a.date;
        return __awaiter(this, void 0, void 0, function () {
            var appointmentDate, findAppointment, appointment, dateFormatted;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        appointmentDate = date_fns_1.startOfHour(date);
                        if (date_fns_1.isBefore(appointmentDate, Date.now())) {
                            throw new AppError_1.default("You can't create appointment on a past date");
                        }
                        if (user_id === provider_id) {
                            throw new AppError_1.default("You can't create appointment with yourself");
                        }
    ...
    CreateAppointmentsService = __decorate([
    ...
    return CreateAppointmentsService;
}());
