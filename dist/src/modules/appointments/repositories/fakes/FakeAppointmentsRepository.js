...
var Appointments_1 = __importDefault(require("../../infra/typeorm/entities/Appointments"));
var AppointmentsRepository = /** @class */ (function () {
    ...
    AppointmentsRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointment;
            return __generator(this, function (_b) {
                appointment = new Appointments_1.default();
                Object.assign(appointment, { id: uuid_1.v4(), provider_id: provider_id, user_id: user_id, date: date });
